...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar el porcentaje de atletas que son medallistas");
	}
	...
	public void ejecutarConsultarPaisDeAtleta() {
		var input = input("Por favor ingrese el nombre de un atleta par consultar su pais");
		calculadora.PaisDelAtleta(input);
	}
	/**
