...
public class CalculadoraEstadisticas
{
	...
	private Pais buscarPais(String nombrePais)
	{
		...
		public void PaisDelAtleta(String elAtleta) {

			for (Atleta atleta : atletas)
		{
			if(atleta.darNombre().equals(elAtleta)) {
			System.out.println("El país del atleta " + atleta + " es: ");
			System.out.println(atleta.darPais().darNombre());
		}
		}	
		}
